...
#if defined(GGML_BACKTRACE_NO_DEBUGGER)
    // Embedders can prohibit debugger subprocesses while retaining useful
    // in-process diagnostics from the platform backtrace implementation.
